...
- **Default model**: gemma4:31b-cloud (Fallback: gpt-5.4 mini) — always keep this as the only/default Ollama model; remove any other Ollama models (GLM-5, Qwen, etc.) if added
